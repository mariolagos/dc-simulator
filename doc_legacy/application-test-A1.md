...
**Purpose:** Verify Norton/diode model and stamp polarity. With no external load, the bus should float to **V ≈ E** and **net current = 0** (hence **P[S]=0**). This catches any sign errors that would otherwise force phantom current.

...
**Purpose:** When |ΔV| < cutoff, regen should be allowed onto the line. With a **receptive
substation** (`allowBackfeed=true`) or other loads, train braking power should flow into the network;
`P_brake ≈ 0` if fully receptive.

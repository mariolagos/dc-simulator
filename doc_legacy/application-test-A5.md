...
**Purpose:** When |ΔV| ≥ vmax (or well above cutoff), the diode prevents line regen; braking should be dumped into the **brake resistor**. This validates `pBrake` path and the under-receptivity accounting.

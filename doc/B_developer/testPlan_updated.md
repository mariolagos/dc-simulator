...
### 3.4 New Tests Added in v1.5
| Test ID | Description | Type | Requirement ID(s) | Expected result |
|---------|-------------|------|-------------------|-----------------|
| **SAN-Chainage** | Chainage parser sanity | Unit | R-08 | Valid “s km+m” strings map to meters; invalids rejected |
| **SMK-Tracks1** | Single-track smoke | Integration | R-04, R-08 | Minimal single-track config completes; long-table CSV present |
| **IT-Tracks2** | Double-track isolation & sharing | Integration | R-04, R-08 | Two parallel tracks; isolation ok; expected sharing; optional crossover |
| **UT-ProfileImport** | Profile importer alignment | Unit | R-02, R-05 | CSV/XLSX aligned within ±½ tick; header validation |
...
| 2025-10-17 | 1.5 | Added new tests (chainage, tracks1 smoke, tracks2 isolation/sharing, profile import); CI and gate criteria |

...
**Purpose:** With **equal EMF** and identical internal resistances, two diode substations interconnected
by lines should settle at **V ≈ E** on both buses, with **~0 line current** and **P[S] ≈ 0**.
This guards against double-injection or mistaken backfeed.

...
//                    : "Device";
//            String fromNode = (d instanceof Substation) ? ((Substation) d).getFromNode()
...
//        double vT = res.getLatestNodeVoltage("GROUND").asDouble();  // tågnod
...
//                String a = ln.getFromNode(), String = ln.getToNode();
